...
public class RBNumero extends RBase{
    ...
    RBNumero(String expresion) {
        try{
            valor = Double.parseDouble(expresion);
        } catch(NumberFormatException e){
            throw new RobertianoException("Error intentando parsear la siguiente expresion: ".concat(expresion));
        }
    }
